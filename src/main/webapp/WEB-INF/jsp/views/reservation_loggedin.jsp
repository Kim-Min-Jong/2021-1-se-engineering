          ...
          <div class="rd-navbar-inner-outer">
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-panel">
                ...
                <!-- RD Navbar Brand-->
                <div class="rd-navbar-brand"><a class="brand" href="mainWeb-logined"><img class="brand-logo-dark"
              ...
              <div class="rd-navbar-right rd-navbar-nav-wrap">
                ...
                <div class="rd-navbar-main">
                  ...
                  <ul class="rd-navbar-nav">
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="reservation_loggedin">Reservation</a>
                    </li>
                    <li class="rd-nav-item"><a class="rd-nav-link" href="reservationCheck_loggedin">Reservation Check</a>
                    </li>
                    <li class="rd-nav-item"><a class="rd-nav-link" href="walkIn_loggedin">Walk In</a>
                    </li>
    ...
    <section class="section section-sm section-first bg-default">
      <div class="container">
        ...
        <form class="rd-form form-style-1"
          method="post" action="RPopUp_reservation_loggedin">
          <div class="row row-20 gutters-20">
            ...
            <div class="col-md-6 col-lg-4 oh-desktop">
              <div class="form-wrap wow slideInUp">
                <input class="form-input" id="time" type="time" name="time" data-constraints="@Required">
                <label class="form-label" for="time"></label>
              </div>
            </div>
            <div class="col-md-6 col-lg-4 oh-desktop">
              <div class="form-wrap wow slideInUp">
                <input class="form-input" id="number" type="text" name="number" data-constraints="@Required"
          ...
          <div class="row row-30 align-items-center">
            <div class="col-sm-6 col-md-7 col-lg-4 col-xl-4">
              <div class="row row-30 align-items-center text-lg-center">
                <div class="col-md-7 col-xl-6"><a class="brand" href="index.html"><img src="resources/images/2.jpg" alt=""
