...
<body>
  ...
  <div class="page">
              ...
              <div class="rd-navbar-right rd-navbar-nav-wrap">
                ...
                <div class="rd-navbar-main">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="reservationCheck_loggedin_user">Reservation Check</a>
                    </li>
    ...
    <section class="section section-sm section-first bg-default">
      <div class="container">
        <h3 class="heading-3">Check Reservation Info</h3>
           ...
           <p> ----------------정보 출력칸 -----------------</p>
            <%
            	...
            	if(mode.equals("user"))
            		path = "_loggedin_user";
            %>
  			<button class="button button-lg button-primary button-winona wow fadeInRight" onclick="location.href='reservationModify<%=path%>'" type="submit">Modify Reservation</button>
            <button class="button button-lg button-primary button-winona wow fadeInRight" onclick="location.href='reservationCancel<%=path%>'" type="submit">Cancel Reservation</button>
      </div>
      </div>
    </section>
            ...
            <div class="col-sm-6 col-md-7 col-lg-4 col-xl-4">
              <div class="row row-30 align-items-center text-lg-center">
                <div class="col-md-7 col-xl-6"><a class="brand" href="mainWeb"><img
                      src="images/2.jpg" alt="" width="198" height="66" /></a></div>
