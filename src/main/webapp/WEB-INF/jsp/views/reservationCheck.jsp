              ...
              <div class="rd-navbar-right rd-navbar-nav-wrap">
                ...
                <div class="rd-navbar-main">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="reservationCheck">Reservation Check</a>
                    </li>
    ...
    <section class="section section-sm section-first bg-default">
      <div class="container">
        ...
        <div class="rd-form form-style-1" >
              <p>------ 정보 출력칸------</p>
            <br>
			<button class="button button-lg button-primary button-winona wow fadeInRight" onclick="location.href='RPopUp_reservationCheck'" type="submit">Check Your Reservation</button>
