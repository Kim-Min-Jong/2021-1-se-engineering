              ...
              <div class="rd-navbar-right rd-navbar-nav-wrap">
                ...
                <div class="rd-navbar-main">
                  ...
                  <ul class="rd-navbar-nav">
                    <li class="rd-nav-item"><a class="rd-nav-link" href="reservation_loggedin">Reservation</a>
                    </li>
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="reservationCheck_loggedin">Reservation Check</a>
                    </li>
