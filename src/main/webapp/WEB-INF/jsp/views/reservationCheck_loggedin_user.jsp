    ...
    <section class="section section-sm section-first bg-default">
      <div class="container">
        ...
        <div class="rd-form form-style-1" >
  			<button class="button button-lg button-primary button-winona wow fadeInRight" onclick="location.href='RPopUp_reservationCheck_loggedin'" type="submit">Check Your Reservation</button>
      </div>
      </div>
    </section>
