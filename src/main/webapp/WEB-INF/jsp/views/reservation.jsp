              ...
              <div class="rd-navbar-right rd-navbar-nav-wrap">
                ...
                <div class="rd-navbar-main">
                  ...
                  <ul class="rd-navbar-nav">
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="reservation">Reservation</a>
                    </li>
    ...
    <section class="section section-sm section-first bg-default">
      <div class="container">
        ...
        <form class="rd-form  form-style-1"
          method="post" action="RPopUp_reservation">
          <div class="row row-20 gutters-20">
            ...
            <div class="col-lg-4 oh-desktop">
              <div class="form-wrap wow slideInDown">
                <!--Select 2-->
                <select class="form-input" data-constraints="@Required">
