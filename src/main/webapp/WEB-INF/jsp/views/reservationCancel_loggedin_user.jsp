...
<body>
	...
	<div class="page">
							...
							<div class="rd-navbar-right rd-navbar-nav-wrap">
									...
									<ul class="rd-navbar-contacts-2">
										<li>
											<div class="unit unit-spacing-xs">
												<div class="unit-body"><%=id%>님 환영합니다! &nbsp; 접속권한:<%=mode%>
												</div>
											</div>
										</li>
										<li>
								...
								<div class="rd-navbar-main">
									...
									<ul class="rd-navbar-nav">
										...
										<li class="rd-nav-item"><a class="rd-nav-link"
											href="reservation_loggedin_user">Reservation Check</a></li>
										<li class="rd-nav-item"><a class="rd-nav-link"
		...
		<section class="section section-sm section-first bg-default">
			<div class="container">
				<h3 class="heading-3">Cancel your Table</h3>
				<%--************************************************************************************************************* --%>
				<form class="rd-formform-style-1"
					method="post" action="RPopUp_reservationCancel_loggedin">
