    ...
    <div class="page">
                                    ...
                                    <ul class="rd-navbar-contacts-2">
                                        <!-- <li>
                                            <div class="unit unit-spacing-xs">
                                                <div class="unit-body"><a class="phone" href="tel:#">환영합니다! xxx님</a>
                                                </div>
                                            </div>
                                        </li> -->
                                        <li>
                                ...
                                <div class="rd-navbar-main">
                                    ...
                                    <ul class="rd-navbar-nav">
                                        <li class="rd-nav-item"><a class="rd-nav-link"
                                                href="mainWeb">Reservation</a>
                                        </li>
                                        <li class="rd-nav-item"><a class="rd-nav-link" href="reservation">Reservation
                                                Check</a>
                                        </li>
        ...
        <section class="section section-sm section-first bg-default">
            <div class="container">
                ...
                <%--************************************************************************************************************* --%>
                <form class="rd-form form-style-1" method="post" action="RPopUp_reservationCancel">
