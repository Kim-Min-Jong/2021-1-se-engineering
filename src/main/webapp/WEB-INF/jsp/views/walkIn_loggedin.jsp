...
<body>
		<%
	String address = (String) session.getAttribute("ID");
	String mode = (String) session.getAttribute("MODE");
	int idx = address.indexOf("@");
	String name = address.substring(0, idx);
	%>
									...
									<ul class="rd-navbar-contacts-2">
										...
										<li>
											<div class="unit unit-spacing-xs">
												<div class="unit-body"><%=name%>님 환영합니다! &nbsp; 접속권한:<%=mode%>
												</div>
											</div>
										</li>
										<li>
		...
		<section class="section section-sm section-first bg-default">
			<div class="container">
				...
				<form class="rd-form form-style-1"
					method="post" action="RPopUp_walkIn_loggedin">
					...
					<br>
					<fieldset>
						<legend class="heading-3" style="text-align: center; left: 20px;">choose
							table</legend>
						<div style="width: 830px; margin: 0 auto;">
							<input type="checkbox" id="check_button1" name="check_button1">
							<label for="check_button1">1</label> <input type="checkbox"
								id="check_button2" name="check_button2"> <label
								for="check_button2">2</label> <input type="checkbox"
								id="check_button3" name="check_button3"> <label
								for="check_button3">3</label> <input type="checkbox"
								id="check_button4" name="check_button4"> <label
								for="check_button4">4</label> <br> <input type="checkbox"
								id="check_button5" name="check_button5"> <label
								for="check_button5">5</label> <input type="checkbox"
								id="check_button6" name="check_button6"> <label
								for="check_button6">6</label> <input type="checkbox"
								id="check_button7" name="check_button7"> <label
								for="check_button7">7</label> <input type="checkbox"
								id="check_button8" name="check_button8"> <label
								for="check_button8">8</label>
						</div>
					</fieldset>
					<input
						class="button button-lg button-primary button-winona wow fadeInRight"
						type="submit" value="Walk in" />
				</form>
				<%--************************************************************************************************************* --%>
			</div>
		</section>
