    ...
    <header class="section page-header">
      ...
      <div class="rd-navbar-wrap">
          ...
          <div class="rd-navbar-inner-outer">
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-panel">
                ...
                <!-- RD Navbar Brand-->
                <div class="rd-navbar-brand"><a class="brand" href="mainWeb-logined_user"><img class="brand-logo-dark"
              ...
              <div class="rd-navbar-right rd-navbar-nav-wrap">
                ...
                <div class="rd-navbar-main">
                  ...
                  <ul class="rd-navbar-nav">
                    <li class="rd-nav-item"><a class="rd-nav-link" href="reservation_loggedin_user">Reservation</a>
                    </li>
                    <li class="rd-nav-item"><a class="rd-nav-link" href="reservationCheck_loggedin_user">Reservation Check</a>
                    </li>
                    <li class="rd-nav-item"><a class="rd-nav-link" href="walkIn_loggedin_user">Walk In</a> 
                    </li>
                    <li class="rd-nav-item"><span class="rd-nav-link" href="#"></span>
                    </li>    
                    <li class="rd-nav-item"><a class="rd-nav-link" href="logout">Log Out</a> 
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div class="swiper-wrapper text-sm-left">
          <div class="swiper-slide context-dark" data-slide-bg="resources/images/restaurant.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
                  <div class="col-sm-9 col-md-8 col-lg-7 col-xl-7 offset-lg-1 offset-xxl-0">
                    <h1 class="oh swiper-title"><span class="d-inline-block" data-caption-animate="slideInUp" data-caption-delay="0">Perfect restaurants</span></h1>
                    <p class="big swiper-text" data-caption-animate="fadeInLeft" data-caption-delay="300">Experience the taste of a perfect restaurants!, one of the best restaurants!</p><a class="button button-lg button-primary button-winona button-shadow-2" href="#" data-caption-animate="fadeInUp" data-caption-delay="300">View our menu</a>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div class="swiper-slide context-dark" data-slide-bg="resources/images/gredient.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
                  <div class="col-sm-8 col-lg-7 offset-lg-1 offset-xxl-0">
                    ...
                    <p class="big swiper-text" data-caption-animate="fadeInRight" data-caption-delay="300">We use only the best ingredients to make one-of-a-kind menus for our customers.</p>
          ...
          <div class="row row-md row-30">
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInUp">
                  <div class="services-terri-figure"><img src="resources/images/salad.jpg" alt="" width="370" height="278"/>
                  </div>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInDown">
                  <div class="services-terri-figure"><img src="resources/images/pizza.jpg" alt="" width="370" height="278"/>
                  </div>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <!-- Services Terri-->
                <article class="services-terri wow slideInUp">
                  <div class="services-terri-figure"><img src="resources/images/burger.jpg" alt="" width="370" height="278"/>
                  </div>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <!-- Services Terri-->
                <article class="services-terri wow slideInDown">
                  <div class="services-terri-figure"><img src="resources/images/dessert.jpg" alt="" width="370" height="278"/>
                  </div>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <!-- Services Terri-->
                <article class="services-terri wow slideInUp">
                  <div class="services-terri-figure"><img src="resources/images/drink.jpg" alt="" width="370" height="278"/>
                  </div>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <!-- Services Terri-->
                <article class="services-terri wow slideInDown">
                  <div class="services-terri-figure"><img src="resources/images/seafood.jpg" alt="" width="370" height="278"/>
                  </div>
      ...
      <div class="container container-style-1">
        <div class="owl-carousel owl-style-12" data-items="1" data-sm-items="2" data-lg-items="3" data-margin="30"
          ...
          <article class="quote-tara">
            <div class="quote-tara-caption">
              <div class="quote-tara-text">
                <p class="q">This restaurant is the longest lasting place in the city and is well run and staffed.
                  Prices are great and allow me to keep coming back.</p>
              </div>
              <div class="quote-tara-figure"><img src="resources/images/user-6-115x115.jpg" alt="" width="115" height="115" />
              </div>
            </div>
          ...
          <article class="quote-tara">
            <div class="quote-tara-caption">
              <div class="quote-tara-text">
                <p class="q">I am a real food addict, and even when I’m home I prefer your food to all others. They
                  taste awesome and are very affordable.</p>
              </div>
              <div class="quote-tara-figure"><img src="resources/images/user-8-115x115.jpg" alt="" width="115" height="115" />
              </div>
            </div>
          ...
          <article class="quote-tara">
            <div class="quote-tara-caption">
              <div class="quote-tara-text">
                <p class="q">This restaurant has amazing pizza. Not only do you get served with a great attitude, you also
                  get delicious foods at a great price!</p>
              </div>
              <div class="quote-tara-figure"><img src="resources/images/user-7-115x115.jpg" alt="" width="115" height="115" />
              </div>
            </div>
          ...
          <article class="quote-tara">
            <div class="quote-tara-caption">
              <div class="quote-tara-text">
                <p class="q">This restaurant has great foods. Not only do you get served with a great attitude and delivered
                  delicious foods, you get a great price.</p>
              </div>
              <div class="quote-tara-figure"><img src="resources/images/user-9-115x115.jpg" alt="" width="115" height="115" />
              </div>
            </div>
              ...
              <div class="group-xmd group-sm-justify">
                ...
                <div class="footer-modern-contacts wow slideInDown">
                  <div class="unit unit-spacing-sm align-items-center">
                    ...
                    <div class="unit-body"><a class="mail" href="mailto:#">@kyonngi.ac.kr</a></div>
                  </div>
                </div>
